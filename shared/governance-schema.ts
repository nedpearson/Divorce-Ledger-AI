...
export const insertPiiCatalogSchema = createInsertSchema(piiCatalog).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertDataLineageSourceSchema = createInsertSchema(dataLineageSources).omit({
  id: true,
  createdAt: true,
});
...
export const insertDataLineageNodeSchema = createInsertSchema(dataLineageNodes).omit({
  id: true,
  createdAt: true,
});
...
export const insertDataLineageEdgeSchema = createInsertSchema(dataLineageEdges).omit({
  id: true,
  createdAt: true,
});
...
export const insertConsentPurposeSchema = createInsertSchema(consentPurposes).omit({
  id: true,
  createdAt: true,
});
...
export const insertRetentionJobSchema = createInsertSchema(retentionJobs).omit({
  id: true,
  startedAt: true,
});
...
export const insertDataQualityTestSchema = createInsertSchema(dataQualityTests).omit({
  id: true,
  createdAt: true,
});
...
export const insertDataQualityTestRunSchema = createInsertSchema(dataQualityTestRuns).omit({
  id: true,
  executedAt: true,
});
...
export const insertMetadataCatalogSchema = createInsertSchema(metadataCatalog).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
