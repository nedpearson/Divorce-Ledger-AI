...
export async function uploadRoutes(fastify: FastifyInstance) {
   ...
   */
  fastify.post('/uploads/generate-url', {
  ...
  fastify.post('/uploads/complete', {
    ...
    if (!metadataResult.success) {
      throw new ValidationError('Invalid upload metadata', { errors: metadataResult.error.errors });
    }
   ...
   */
  fastify.delete('/uploads/:filePath', {
    onRequest: [fastify.authenticate],
  }, async (request: FastifyRequest<{
