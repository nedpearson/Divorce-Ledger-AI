...
router.get('/status', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.get('/events', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.get('/topics', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
    const result = await safeQuery(
      getPool(),
...
router.get('/consumers', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.post('/processors/start', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.post('/processors/stop', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
    stopAllProcessors();
    const status = await getProcessorStatus();
...
router.post('/outbox/process', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.post('/dlq/:id/retry', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.post('/publish', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
...
router.post('/consumers/:groupId/reset', checkEventsDisabled, requireAdminSecret, async (req: Request, res: Response) => {
  try {
