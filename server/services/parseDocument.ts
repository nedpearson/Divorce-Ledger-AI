...
export const LegalObligationSchema = z.object({
  ...
  category: z.string().optional().nullable().catch(null),
  party_a_role: z.string().optional().nullable().catch(null),
  party_b_role: z.string().optional().nullable().catch(null),
  party_a_percentage: z.number().optional().nullable().catch(null),
  party_b_percentage: z.number().optional().nullable().catch(null),
  fixed_amount: z.number().optional().nullable().catch(null),
  effective_start_date: z.string().optional().nullable().catch(null),
  effective_end_date: z.string().optional().nullable().catch(null),
  explanation: z.string().optional().nullable().catch(null),
});
...
export const ExpenseDocumentSchema = z.object({
  ...
  language: Language,
  doc_type: DocType,
  vendor_name: z.string().optional().nullable().catch(null),
  account_number: z.string().optional().nullable().catch(null),
  billing_period_start: z.string().optional().nullable().catch(null),
  billing_period_end: z.string().optional().nullable().catch(null),
  statement_date: z.string().optional().nullable().catch(null),
  due_date: z.string().optional().nullable().catch(null),
  currency: z.string().optional().nullable().catch('USD'),
  total_amount_due: z.number().optional().nullable().catch(null),
  total_amount_text: z.string().optional().nullable().catch(null),
  customer_name: z.string().optional().nullable().catch(null),
  service_address: z.string().optional().nullable().catch(null),
  mailing_address: z.string().optional().nullable().catch(null),
