...
export function DrillDownValue({
  ...
  const baseClasses =
    'inline-flex items-center gap-1 group whitespace-nowrap outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm transition-colors text-primary hover:text-primary/80';
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <span
              className={
                asBadge ? '' : 'border-b border-dashed border-primary/50 group-hover:border-primary'
              }
            >
              {value}
            </span>
