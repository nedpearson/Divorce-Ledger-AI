              ...
              {editing === plan.id ? (
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 pt-1">
                    <Button
                      size="sm"
                      onClick={() => updateMutation.mutate({ planId: plan.id, data: editData })}
                ...
                <>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span>${(plan.priceCents / 100).toFixed(2)}/mo</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">AI Credits</span>
                      <span>{plan.aiCreditsMonthly?.toLocaleString()}/mo</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Matters</span>
                      <span>{plan.mattersLimit ?? '∞'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Seats</span>
                      <span>{plan.seatsLimit ?? '∞'}</span>
                    </div>
                    {plan.stripePriceId && (
                      <div className="flex justify-between">
