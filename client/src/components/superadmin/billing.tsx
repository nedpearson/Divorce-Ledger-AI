            ...
            {data?.map((ws: any) => (
              <tr key={ws.id} className="border-b hover:bg-muted/30 transition-colors">
                ...
                <td className="p-2 text-xs">
                  {ws.aiCreditsBalance}/{ws.aiCreditsLimit}
                </td>
                <td className="p-2">
                  {ws.stripeCustomerId ? (
                    <a
                ...
                <td className="p-2">
                  <Dialog
                    open={graceTarget === ws.id}
                    onOpenChange={(open) => setGraceTarget(open ? ws.id : null)}
                  >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Apply Grace Period — {ws.name}</DialogTitle>
                      </DialogHeader>
