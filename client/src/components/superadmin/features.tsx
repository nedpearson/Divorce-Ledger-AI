  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-muted-foreground bg-blue-50 dark:bg-blue-950/20 rounded p-3 border border-blue-200 dark:border-blue-900">
        ...
        <p className="mt-1">Per-workspace and per-user toggles are managed via the Firms and Users panels.</p>
      </div>
                ...
                <td className="p-3">
                  <div className="flex items-center gap-2">
                    <Switch
                      ...
                      onCheckedChange={enabled => isSuperAdmin && toggleMutation.mutate({ key: flag.key, enabled })}
