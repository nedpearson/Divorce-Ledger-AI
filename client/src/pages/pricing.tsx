      ...
      <div className="container max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-6 md:space-y-8">
        <div className="text-center space-y-3 md:space-y-4">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto px-4">
            Powerful forensic financial tools for divorce proceedings. AI-powered analysis with
        ...
        <Card className="border-purple-200 dark:border-purple-800 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/30 dark:to-blue-950/30">
          ...
          <CardContent className="space-y-2">
            <p className="text-muted-foreground">
              AI Credits power intelligent features like document analysis, pattern detection, and
              voice transcription. Here's what typical operations cost:
            </p>
            <ul className="grid md:grid-cols-2 gap-2 text-sm">
              <li>
                • Document Classification: <strong>10 credits</strong>
              </li>
              <li>
                • Document Parsing: <strong>25 credits</strong>
              </li>
              <li>
                • Voice Transcription: <strong>5 credits/minute</strong>
              </li>
              <li>
                • Image Analysis: <strong>20 credits</strong>
              </li>
              <li>
                • Case Builder Assistant: <strong>50 credits</strong>
              </li>
              <li>
                • Court Filing Review: <strong>75 credits</strong>
              </li>
            </ul>
            <p className="mt-4 text-sm text-muted-foreground">
              Credits reset monthly. Need more? Choose <strong>METERED</strong> mode to
              automatically purchase overages at $0.10 per 10 credits.
            </p>
          </CardContent>
        </Card>
      </div>
