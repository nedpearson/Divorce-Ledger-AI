      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-lg text-gray-600">
            Simple evidence capture: Camera + Voice Notes
          </p>
            ...
            {installUrl.includes('localhost') && (
              <div className="w-full max-w-md p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                <p className="text-xs text-yellow-800">
                  ⚠️ <strong>Note:</strong> This URL uses "localhost" which won't work on your phone. 
                  Please access this page using your computer's IP address (like http://192.168.1.x:5000/mobile-install) 
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Open your phone's camera app and point it at the QR code above. Tap the notification to open the link.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Tap "Add to Home Screen" or "Install" when prompted. The app will be added to your phone like a native app.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Use camera to scan documents, voice notes to describe violations. Everything saves locally and syncs automatically on WiFi.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        {localIp ? (
          <Alert>
            <Wifi className="h-4 w-4" />
            <AlertDescription>
              <strong>Desktop IP:</strong> {localIp}<br />
          ...
          <Alert>
            <Wifi className="h-4 w-4" />
            <AlertDescription>
              <strong>Important:</strong> Connect your phone to the same WiFi network as this computer.<br />
              <span className="text-sm text-muted-foreground">
                If the QR code doesn't work, manually enter the URL on your phone using your computer's local IP address.
              </span>
            </AlertDescription>
          </Alert>
        )}
        ...
        <Card className="border-orange-200 bg-orange-50">
          <CardHeader>
            <CardTitle className="text-orange-900">🔧 Troubleshooting "Unreachable" Error</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
              <h4 className="font-semibold text-orange-900 mb-2">If you see "localhost unreachable":</h4>
              <ol className="list-decimal list-inside space-y-2 text-sm text-orange-800">
                <li>
                  ...
                  <ul className="ml-6 mt-1 space-y-1 list-disc">
                    <li><strong>Windows:</strong> Open Command Prompt → type <code className="bg-white px-1 rounded">ipconfig</code> → look for "IPv4 Address" (like 192.168.1.x)</li>
                    <li><strong>Mac:</strong> System Preferences → Network → look for "IP Address"</li>
                  </ul>
                </li>
                <li>
                  <strong>Access this page using your IP:</strong> Open <code className="bg-white px-1 rounded">http://YOUR-IP:5000/mobile-install</code> (example: http://192.168.1.100:5000/mobile-install)
                </li>
                <li>
                  <strong>Scan the new QR code</strong> that appears with your actual IP address
                </li>
                <li>
                  <strong>Verify WiFi:</strong> Make sure your phone and computer are on the <strong>same WiFi network</strong>
                </li>
              </ol>
            </div>
          </CardContent>
        ...
        <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200">
          <CardHeader>
            ...
            <CardDescription>
              Two easy ways to capture evidence on your phone
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm">
                      <strong>Camera:</strong> Take photos of financial statements, court orders, receipts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">
                      <strong>Voice Notes:</strong> Speak to add descriptions - automatically converted to text
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-white/80 rounded-lg p-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm">
                      <strong>Camera:</strong> Document custody violations, property damage, incidents
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">
                      <strong>Voice Notes:</strong> Describe what happened in your own words - hands-free
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
