import { FileText, AlertTriangle, MessageSquare, Calendar, Scale, Users, Home, BarChart3, Bot, Settings, Construction } from "lucide-react";
...
export default function PlaceholderPage({ page }: { page: string }) {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 pb-24 md:pb-6">
      ...
      <div>
        <h1 className="text-2xl font-semibold mb-1" data-testid="text-page-title">{config.title}</h1>
