    ...
    <Card className="group hover-elevate" data-testid={`insight-${insight.id}`}>
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          <div className="p-2 bg-muted rounded-md">{icons[insight.type]}</div>
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content:
        "Hello! I'm your AI case coach. I can help you understand legal strategies, analyze your case documents, and provide guidance on divorce proceedings. How can I assist you today?",
      timestamp: new Date(),
    },
  ]);
  ...
  const sampleInsights: Insight[] = [
    {
      ...
      description:
        '3 bank statements from the past year have not been uploaded. Complete financial records strengthen your case.',
      priority: 'high',
    },
    {
      id: '2',
      ...
      description:
        'Based on your work schedule, a 2-2-3 custody arrangement may be more practical than the current proposal.',
      priority: 'medium',
    },
    {
      id: '3',
      ...
      description:
        'Filing jointly this year could save approximately 15% in taxes. Consider discussing with your attorney.',
      priority: 'medium',
    },
    {
      id: '4',
      ...
      description:
        'Your response to the motion for temporary support is due in 5 days. Review and finalize your response.',
      priority: 'high',
    },
  ];
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Get AI-powered strategy suggestions and case analysis.
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                AI reviews your uploaded documents to identify missing information and
                inconsistencies.
              </p>
            </div>
            <div className="text-center">
