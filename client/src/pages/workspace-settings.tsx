        ...
        <TabsContent value="usage" className="space-y-4 mt-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span>
                  {entitlements.aiCredits.used.toLocaleString()} /{' '}
                  {entitlements.aiCredits.limit.toLocaleString()} used
                </span>
              ...
              <Progress
                ...
                className={getProgressColor(
                  entitlements.aiCredits.used,
                  entitlements.aiCredits.limit
                )}
              />
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span>
                  {entitlements.matters.used} /{' '}
                  {entitlements.matters.limit === -1 ? 'Unlimited' : entitlements.matters.limit}
                </span>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span>
                  {entitlements.seats.used} /{' '}
                  {entitlements.seats.limit === -1 ? 'Unlimited' : entitlements.seats.limit}
                </span>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between text-sm">
                <span>
                  {(entitlements.storage.used / 1024 / 1024).toFixed(2)} MB /{' '}
                  {(entitlements.storage.limit / 1024 / 1024).toFixed(0)} MB
                </span>
                <span className="text-muted-foreground">
